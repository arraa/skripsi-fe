...
import { StudentScoringPerSubject, StudentScoringPerSubjectForm } from './types/types';
  ...
  >(studentScorings);
    ...
    const onSubmit = (data: StudentScoringPerSubject) => {
        ...
        const submittedData = studentAttendanceList.map((student) => {
            ...
            const studentScore = data[reasonKey as keyof StudentScoringPerSubject];
                ...
                >
                    <div className=' flex w-full justify-start text-base  text-[#0c42777a] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2  '>
                        ...
                        PAS
                                            ...
                                            <div
                                                className='cursor-pointer p-2 hover:bg-gray-100'
                                                onClick={() => handleOptionChange('PTS')}
                                            >
                        PTS
                                            </div>
                                            <div
                                                className='cursor-pointer p-2 hover:bg-gray-100'
                                                onClick={() => handleOptionChange('Tambahkan opsi')}
                                            >
                        Tambahkan Tugas Lainnya
                                            </div>
                                            {selectedOption === 'Tambahkan opsi' && (
                                                <>
                                                    <div className='p-2'>
                                                        <input
                                                            type='text'
