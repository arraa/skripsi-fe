        ...
        >
            <div className='flex h-full w-1/2 flex-col items-start justify-center gap-10 rounded-l-[3rem] bg-white px-20 py-60 text-3xl  text-black'>
                <div className='flex flex-col gap-3'>
                    <div className='text-5xl font-bold text-[#0C4177]'>Welcome Back</div>
              ...
              Confirm Password
                        ...
                        <div className='relative'>
                            <input
                                ...
                                className='mt-1 w-full rounded-md border bg-[#3F79B4]/10 px-3 py-4 font-medium shadow-sm sm:text-sm'
