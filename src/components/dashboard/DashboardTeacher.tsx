    ...
    return (
        <Box sx={{ padding: 2, width: '87vw' }}>
            <div className='flex items-center justify-between'>
                <div className='my-5 text-3xl font-bold text-[#0C4177]'>Hi, Teacher!</div>
                
                <Link href='/attendance/today' className='flex h-fit items-center justify-center rounded-md bg-[#0C4177] px-20 py-3 text-center font-bold  text-white'>
                        CLASS  ATTENDANCE
                </Link>
            ...
            <div className='flex flex-col justify-between gap-y-10'>
                        ...
                        <div className='w-[48%]'>
                            ...
                            {events.map((event, index) => (
                                ...
                                >
                                    ...
                                    <div className='font-bold text-[#0c4277] '>{event.title}</div>
                                </Box>
                            ))}
                        </div>
                    </div>
                ...
                <div className='flex justify-between '>
                    <div className='flex h-[40vh]  w-[48%] flex-col justify-between  rounded-3xl bg-white p-5 px-14 text-[#0C4177] shadow-lg'>
                        <div className='flex items-center justify-between'>
                            <div className='text-2xl font-bold '>Learning Plan</div>
                            <div className='text-xl'>Pertemuan 1 - 7A</div>
                        </div>
                        <div>
                            <div className='text-xl font-bold '>Tujuan Pembelajaran</div>
                            <div>B.1 Membaca, menuliskan dan membandingkan bilangan rasional, bilangan bulat positif dan bilangan bulat negative</div>
                            <div>B.2 Membaca, mengidentifikasi, menuliskan dan membandingkan bilangan desimal,pecahan</div>
                            <div>B.3 Mengidentifikasikan jenis-jenis bilangan dari himpunan bilangan yang diberikan</div>
                        </div>
                        <div>
                            <div className='text-xl font-bold '>Metode Pembelajaran</div>
                            <div>Penjelasan Materi, Soal Latihan, Mini Quiz</div>
                        </div>
                    ...
                    <div className='flex h-[40vh] w-[48%] flex-col rounded-3xl bg-white p-5 px-14 text-[#0c4277] shadow-lg'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <div className='mt-2 flex w-full items-end justify-end'>
                                <Link href='/scoring/subject' className=' rounded-lg bg-[#0C4177] p-2 px-6 text-center text-white'>See Detail</Link>
