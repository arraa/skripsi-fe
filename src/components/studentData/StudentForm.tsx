...
const StudentForm = () => {
  ...
  //change this base on you params
  ...
  // for open the dialog import data
  const handleDialog = () => {
    setOpen(!open);
  };

  // this is for get data when you update, you can see the function 'getStudent()' in app -> api -> student.ts
  ...
  // this is function for submit data
  const onSubmit = async (data: ObjectInput) => {
    ...
    try {
      // this is for check the actionType update or delete and call api in app -> api -> student.ts
      ...
      //if function return true or success to update or create will redirect to /personal-data/student dont forget to change path
      setTimeout(() => {
  ...
  // for format phone number dont changes if you have data phone number
  ...
  // for format date dont changes if you have data date
  ...
  // this is for upload file bye excel
  const handleFileUpload = async (file: File | null) => {
    ...
    reader.onload = async (event) => {
      ...
      if (studentData.length > 0) {
        // change StudentDataProps based on types name
        ...
        try {
          ...
          //call api in app -> api -> student.ts
      ...
      <div className='min-h-screen w-full rounded-3xl bg-white p-5 text-[#0c427770] shadow-md'>
        ...
        >
          ...
          <div className='grid grid-cols-2 gap-x-16 gap-y-6'>
            {/* call controlerFiled if your data is free text or number, if the data date you can add atribut type='date' */}
            ...
            {/* call ControllerSelectField if your data is selected and change the option for data */}
